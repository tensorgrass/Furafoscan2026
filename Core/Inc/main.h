...
#define MOTOR_RIGHT_TIM3_CH1_Pin GPIO_PIN_6
#define MOTOR_RIGHT_TIM3_CH1_GPIO_Port GPIOA
#define MOTOR_LEFT_TIM3_CH1_Pin GPIO_PIN_7
#define MOTOR_LEFT_TIM3_CH1_GPIO_Port GPIOA
